...
class QuickShoppingModal extends StatefulWidget {
  const QuickShoppingModal({super.key});

  @override
  State<QuickShoppingModal> createState() => _QuickShoppingModalState();
}

class _QuickShoppingModalState extends State<QuickShoppingModal> {
  @override
  Widget build(BuildContext context) {
    return Container(
      padding: const EdgeInsets.all(20),
      // Make it full width and rounded top
    ...
    showDialog(
      ...
      builder: (context) => _QuickAmountDialog(
        ...
        onSave: (amount) {
          ...
          _saveTransaction(parentContext, item, amount);
        },
      ),
    );
  }
  ...
  Future<void> _saveTransaction(
      BuildContext context, QuickShoppingItemModel item, double amount) async {
    ...
    Navigator.pop(context); // Close Quick Shopping Modal
  }
}
