              ...
              children: [
                        ...
                        if (state is BudgetLoaded) {
                          ...
                          if (selectedExists) {
                            final b = state.budgets.firstWhere(
                                (element) =>
                                    element.id == _quickShoppingBudgetId,
                        ...
                        if (state is BudgetLoaded) {
                          return Column(
                            children: state.budgets
                                .map((budget) =>
                                    _buildBudgetRow(context, budget))
                                .toList(),
                          );
                        }
                ...
                _buildCard(
                  ...
                  children: [
                    ...
                    // List
                    BlocBuilder<RecurringTransactionBloc,
                      ...
                      child: InputDecorator(
                        ...
                        child: _selectedCategoryId != null
                            ? (() {
                                ...
                                if (category.id != null) {
                                  final staticMap =
                                      CategoryIcons.getCategoryById(
                                          category.id!);
                                  if (staticMap['id'] == category.id) {
                                    final iconData =
                                        staticMap['icon'] as IconData;
                                    if (category.icon ==
                                        String.fromCharCode(
                                            iconData.codePoint)) {
                ...
                _buildCard(
                  ...
                  icon: null,
                  children: [
                    _buildMemberRow('Chồng',
                        'assets/images/user1.png'), // Placeholder asset
                    const SizedBox(height: 12),
